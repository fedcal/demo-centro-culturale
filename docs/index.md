...
hero:
  name: "Demo Centro Culturale"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://centro-culturale.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-centro-culturale
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Centro Culturale.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Centro Culturale** in Italia.
...
Il mercato italiano delle PMI per **Centro Culturale** ha caratteristiche specifiche:
...
```bash
npm run build
npm run serve:ssr:centro-culturale
# → http://localhost:4000
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-centro-culturale)
