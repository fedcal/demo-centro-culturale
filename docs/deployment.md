...
URL: `https://centro-culturale.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `centro-culturale.demo.federicocalo.dev`
...
- Output directory: `dist/centro-culturale/browser`
...
URL: `https://fedcal.github.io/federico-demo-centro-culturale/`
...
- `base: /federico-demo-centro-culturale/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `centro-culturale-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   centro-culturale-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `centro-culturale-docs.federicocalo.dev`
